...
int Value::compare(const Value &other) const
{
  if (this->attr_type_ == other.attr_type_) {
    ...
    return common::compare_float((void *)&this->num_value_.float_value_, (void *)&other_data);
     ...
     int right_data = atoi(other.get_string().c_str());
    return common::compare_int((void *)&this->num_value_.int_value_, (void *)&right_data);
   ...
   float right_data = atof(other.get_string().c_str());
    return common::compare_float((void *)&this->num_value_.float_value_, (void *)&right_data);
...
void Value::set_date(int32_t date) {//px后来所加，希望有利无弊
    attr_type_ = DATES;
